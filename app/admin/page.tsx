...
export default function AdminPage() {
  ...
  const navItems = [
    { id: "overview"  as const, label: "Genel Bakış",  icon: <Home size={15}/> },
    { id: "users"     as const, label: "Kullanıcılar", icon: <Users size={15}/> },
    { id: "qrcodes"   as const, label: "QR Kodlar",    icon: <QrCode size={15}/> },
    { id: "analytics" as const, label: "Analizler",    icon: <BarChart2 size={15}/> },
  ];
