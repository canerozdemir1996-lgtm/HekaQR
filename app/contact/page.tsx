...
export default function ContactPage() {
  return <PublicSiteShell mainClassName="bg-slate-50 px-4 py-10 dark:bg-[#030712] sm:px-6 sm:py-16"><JsonLd data={{
    ...
    <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start"><section>
