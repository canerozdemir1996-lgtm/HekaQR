    ...
    <CardContainer className="inter-var">
      ...
      <CardBody className="bg-white/10 dark:bg-black/40 backdrop-blur-xl relative group/card border border-white/20 dark:border-white/10 w-auto sm:w-[350px] h-auto rounded-3xl p-8 flex flex-col items-center text-center shadow-[0_8px_32px_0_rgba(168,85,247,0.15)] hover:shadow-[0_8px_32px_0_rgba(168,85,247,0.3)] transition-all duration-500">
        ...
        <CardItem translateZ="100" className="w-32 h-32 mt-4 relative">
          ...
          <Image
            src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=256&auto=format&fit=crop"
            height={256}
            width={256}
            className="h-full w-full object-cover rounded-full border-4 border-white/20 dark:border-slate-800/50 relative z-10"
            alt="Örnek dijital kartvizit profil fotoğrafı"
          />
        </CardItem>
        ...
        <CardItem translateZ="80" className="flex gap-4 mt-6">
          <button type="button" aria-label="LinkedIn profili" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-violet-500 hover:text-white transition-colors text-slate-600 dark:text-slate-300 border border-white/10">
            <Linkedin className="w-4 h-4" />
          </button>
          <button type="button" aria-label="Twitter profili" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-violet-500 hover:text-white transition-colors text-slate-600 dark:text-slate-300 border border-white/10">
            <Twitter className="w-4 h-4" />
          </button>
          <button type="button" aria-label="Konum" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-violet-500 hover:text-white transition-colors text-slate-600 dark:text-slate-300 border border-white/10">
