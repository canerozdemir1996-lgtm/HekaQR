...
=======
- Canlı ortamın farklı Supabase projesine bağlı olduğu tespit edildi; profil, rezervasyon ve geri bildirim API'lerine eski şema uyumluluk fallback'leri eklendi.
- Son kullanıcıya gösterilen genel "migrationları uygulayın" mesajı kaldırıldı; gerçek hata kodu yalnızca sunucu logunda tutuluyor.
>>>>>>> Stashed changes
